...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 60%; margin-right: 0px;">
        ...
        <tr>
            <td class="auto-style1">Quantity Available:</td>
            <td class="auto-style2">
        ...
        <tr>
            ...
            <td class="auto-style2">
                <asp:TextBox ID="PriceTextBox" runat="server" Width="275px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style1">Unit Cost:</td>
            <td class="auto-style2">
                <asp:TextBox ID="UnitCostTextBox" runat="server" Width="275px"></asp:TextBox>
            </td>
        </tr>
        <tr>
